...
@Component({
  selector: 'app-suppliers-assigned-list',
  templateUrl: './suppliers-assigned-list.component.html',
  styleUrls: ['./suppliers-assigned-list.component.scss']
})
export class SuppliersAssignedListComponent implements OnInit {
        ...
        const list: Array<any> = [
          {
            ...
            category: 34,
            subcategory: 23,
            state: '<span class="badge badge__dotted--success">Pagada</span>', // Estado
            action: 'Pagar' // disabled
          },
          {
            name: 'Construcción edificio de Av. Álvarez Thomas 1131',
            code: '12121212',
            ...
            category: 34,
            subcategory: 23,
            state: '<span class="badge badge__dotted--warning">Pendiende de Pago</span>', // Estado
            action: 'Pagar'
          },
          {
            name: 'Construcción edificio de Av. Álvarez Thomas 1131',
            ...
            category: 34,
            subcategory: 23,
            state: '<span class="badge badge__dotted--light">Vencida/span>', // Estado
            action: 'Pagar' // disabled
          },
          {
            name: 'Construcción edificio de Av. Álvarez Thomas 1131',
