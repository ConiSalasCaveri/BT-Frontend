...
@Component({
  selector: 'app-suppliers-finish-list',
  templateUrl: './suppliers-finish-list.component.html',
  styleUrls: ['./suppliers-finish-list.component.scss']
})
export class SuppliersFinishListComponent implements OnInit {
