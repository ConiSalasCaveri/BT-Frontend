...
@Component({
  selector: 'app-petitioners-publish-list',
  templateUrl: './petitioners-publish-list.component.html',
  styleUrls: ['./petitioners-publish-list.component.scss']
})
export class PetitionersPublishListComponent implements OnInit, OnDestroy {
    ...
    this.dtOptions = this.datatablesService.buildOptions({
      ajax: (params: any, callback) => {
        ...
        this.subscription = this.petitionService
          .getPetitionsPublish(pageParams, sortParams, search, PetitionsGroups.Published, this.filters)
          .subscribe(response => {
