...
@Component({
  selector: 'app-suppliers-available-list',
  templateUrl: './suppliers-available-list.component.html',
  styleUrls: ['./suppliers-available-list.component.scss']
})
export class SuppliersAvailableListComponent implements OnInit {
        ...
        const list: Array<any> = [
          {
            ...
            category: 34,
            subcategory: 23,
            state: '<span class="badge badge__dotted--success">Ofertada</span>', // Estado
            action: 'Ofertar'
          },
          {
            name: 'Construcción edificio de Av. Álvarez Thomas 1131',
            ...
            category: 34,
            subcategory: 23,
            state: '<span class="badge badge__dotted--warning">Disponible</span>', // Estado
            action: 'Ofertar'
          },
          {
            name: 'Construcción edificio de Av. Álvarez Thomas 1131',
